	...
	$('.contact-form form').submit(function(e) {
	    ...
	    $.ajax({
	        ...
	        success: function(json) {
	            ...
	            if(json.emailMessage == '' && json.nameMessage == '' && json.phoneMessage == '' && json.messageMessage == '') {
	                $('.contact-form form').fadeOut('fast', function() {
	                    $('.contact-form').append('<div class="alert alert-warning">Спасибо за обращение, скоро мы с вами свяжемся!</div>');
	                });
	            }
	        }
	    });
